        ...
        <div class="sidebar-list mb-5">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @if ($user->role === 'Admin')
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Daftar User' || $subTitle === 'Edit User') active @endif"
                                    href="/daftar-user">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Data Kelompok UKT') active @endif" data-bs-toggle="collapse"
                            href="#sidebar-kelompok-ukt" role="button" aria-expanded="false"
                            aria-controls="sidebar-kelompok-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <ul class="sub-nav collapse" id="sidebar-kelompok-ukt" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Tambah Kelompok UKT') active @endif"
                                    href="/tambah-kelompok-ukt">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Daftar Kelompok UKT' || $subTitle === 'Edit Kelompok UKT') active @endif"
                                    href="/daftar-kelompok-ukt">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Data Kriteria' || $title === 'Data Nilai Kriteria') active @endif" data-bs-toggle="collapse"
                            href="#sidebar-kriteria" role="button" aria-expanded="false"
                            aria-controls="sidebar-kriteria">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-kriteria" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Tambah Kriteria') active @endif"
                                    href="/tambah-kriteria">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Daftar Kriteria' || $subTitle === 'Edit Kriteria' || $title === 'Data Nilai Kriteria') active @endif"
                                    href="/daftar-kriteria">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Kelola Penentuan UKT' || $subTitle === 'Cek Berkas') active @endif" aria-current="page"
                            href="/kelola-penentuan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Laporan Penentuan UKT') active @endif" aria-current="page"
                            href="/laporan-penentuan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Kelola Penangguhan UKT') active @endif" aria-current="page"
                            href="/kelola-penangguhan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Laporan Penangguhan UKT') active @endif" aria-current="page"
                            href="/laporan-penangguhan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Kelola Penurunan UKT' || $subTitle === 'Cek Pemberkasan') active @endif" aria-current="page"
                            href="/kelola-penurunan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Laporan Penurunan UKT') active @endif" aria-current="page"
                            href="/laporan-penurunan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Daftar Log') active @endif" aria-current="page"
                            href="/daftar-log">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($subTitle === 'Pengaturan') active @endif" aria-current="page"
                            href="/pengaturan">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                @elseif($user->role === 'Tim Proyek')
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Penentuan UKT') active @endif" aria-current="page"
                            href="/penentuan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Penangguhan UKT') active @endif"
                            data-bs-toggle="collapse" href="#sidebar-penangguhan-ukt" role="button"
                            aria-expanded="false" aria-controls="sidebar-penangguhan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-penangguhan-ukt" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Pengajuan Penangguhan UKT' || $subTitle === 'Edit Penangguhan UKT') active @endif"
                                    href="/pengajuan-penangguhan-ukt">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Riwayat Penangguhan UKT') active @endif"
                                    href="/riwayat-pengajuan-penangguhan-ukt">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Penurunan UKT') active @endif" aria-current="page"
                            href="/pengajuan-penurunan-ukt">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                ...
                @elseif($user->role === 'Head Office')
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($title === 'Data Mahasiswa') active @endif"
                            data-bs-toggle="collapse" href="#sidebar-mahasiswa" role="button" aria-expanded="false"
                            aria-controls="sidebar-mahasiswa">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <ul class="sub-nav collapse" id="sidebar-mahasiswa" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Tambah Mahasiswa') active @endif"
                                    href="/tambah-mahasiswa">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Daftar Mahasiswa' || $subTitle === 'Edit Mahasiswa') active @endif"
                                    href="/daftar-mahasiswa">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if ($subTitle === 'Daftar Alumni' || $subTitle === 'Edit Alumni') active @endif"
                                    href="/daftar-alumni">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
