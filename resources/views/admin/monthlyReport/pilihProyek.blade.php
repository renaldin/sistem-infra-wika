                        ...
                        <form action="/pilih-proyek" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="id_proyek" id="id_proyek" class="selectpicker form-control @error('id_proyek') is-invalid @enderror" data-style="py-0" @if($form === 'Detail') disabled @endif required>
                                        @if ($form === 'Tambah')
