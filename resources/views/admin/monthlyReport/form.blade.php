...
@section('content')
<form action="@if($form === 'Tambah') /tambah-tim-proyek @elseif($form === 'Edit') /edit-tim-proyek/{{$detail->id_proyek}} @endif" method="POST">
    @csrf
    <div class="row">
                    ...
                    <div class="new-user-info">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="tiga_d">3D</label>
                                <select name="tiga_d" id="tiga_d" class="selectpicker form-control @error('tiga_d') is-invalid @enderror" data-style="py-0" @if($form === 'Detail') disabled @endif>
                                    <option value="" selected disabled>-- Pilih --</option>
                                    <option value="1" @if($detail->tiga_d === 1) selected @endif)>Sudah</option>
                                    <option value="0" @if($detail->tiga_d === 0) selected @endif)>Belum</option>
                                </select>
                                @error('tiga_d')
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="empat_d">4D</label>
                                <select name="empat_d" id="empat_d" class="selectpicker form-control @error('empat_d') is-invalid @enderror" data-style="py-0" @if($form === 'Detail') disabled @endif>
                                    <option value="" selected disabled>-- Pilih --</option>
                                    <option value="1" @if($detail->empat_d === 1) selected @endif)>Sudah</option>
                                    <option value="0" @if($detail->empat_d === 0) selected @endif)>Belum</option>
                                </select>
                                @error('empat_d')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="lima_d">5D</label>
                                <select name="lima_d" id="lima_d" class="selectpicker form-control @error('lima_d') is-invalid @enderror" data-style="py-0" @if($form === 'Detail') disabled @endif>
                                    <option value="" selected disabled>-- Pilih --</option>
                                    <option value="1" @if($detail->lima_d === 1) selected @endif)>Sudah</option>
                                    <option value="0" @if($detail->lima_d === 0) selected @endif)>Belum</option>
                                </select>
                                @error('lima_d')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="cde">CDE</label>
                                <select name="cde" id="cde" class="selectpicker form-control @error('cde') is-invalid @enderror" data-style="py-0" @if($form === 'Detail') disabled @endif>
                                    <option value="" selected disabled>-- Pilih --</option>
                                    <option value="1" @if($detail->cde === 1) selected @endif)>Sudah</option>
                                    <option value="0" @if($detail->cde === 0) selected @endif)>Belum</option>
                                </select>
                                @error('cde')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="new-user-info">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('realisasi_proyek') is-invalid @enderror" id="realisasi_proyek" name="realisasi_proyek" value="@if($form === 'Tambah'){{ old('realisasi_proyek') }}@elseif($form === 'Edit'){{$detail->realisasi_proyek}}@endif" @if($form === 'Detail') disabled @endif autofocus placeholder="Masukkan Realisasi Proyek">
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="implementasi_bim">Implementasi Bim</label>
                                <input type="text" class="form-control @error('implementasi_bim') is-invalid @enderror" id="implementasi_bim" name="implementasi_bim" value="@if($form === 'Tambah'){{ old('implementasi_bim') }}@elseif($form === 'Edit'){{$detail->implementasi_bim}}@endif"  @if($form === 'Detail') disabled @endif placeholder="Masukkan Implementasi Bim">
                                @error('implementasi_bim')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" for="kesiapan_bim5d">Kesiapan Bim 5D</label>
                                <input type="text" class="form-control @error('kesiapan_bim5d') is-invalid @enderror" id="kesiapan_bim5d" name="kesiapan_bim5d" value="@if($form === 'Tambah'){{ old('kesiapan_bim5d') }}@elseif($form === 'Edit'){{$detail->kesiapan_bim5d}}@endif"  @if($form === 'Detail') disabled @endif placeholder="Masukkan Kesiapan Bim 5D">
                                @error('kesiapan_bim5d')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('progress') is-invalid @enderror" id="progress" name="progress" value="@if($form === 'Tambah'){{ old('progress') }}@elseif($form === 'Edit'){{$detail->progress}}@endif"  @if($form === 'Detail') disabled @endif placeholder="Masukkan Progress">
                                @error('progress')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
