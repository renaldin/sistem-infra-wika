                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$realisasiJan}}</td>
                                <td>{{round($realisasiJan / $detailProgress['januari']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Februari</td>
                                ...
                                <td>{{$realisasiFeb}}</td>
                                <td>{{round($realisasiFeb / $detailProgress['februari']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Maret</td>
                                ...
                                <td>{{$realisasiMar}}</td>
                                <td>{{round($realisasiMar / $detailProgress['maret']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>April</td>
                                ...
                                <td>{{$realisasiApr}}</td>
                                <td>{{round($realisasiApr / $detailProgress['april']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td>Mei</td>
                                ...
                                <td>{{$realisasiMei}}</td>
                                <td>{{round($realisasiMei / $detailProgress['mei']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>6</td>
                                <td>Juni</td>
                                ...
                                <td>{{$realisasiJun}}</td>
                                <td>{{round($realisasiJun / $detailProgress['juni']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>7</td>
                                <td>Juli</td>
                                ...
                                <td>{{$realisasiJul}}</td>
                                <td>{{round($realisasiJul / $detailProgress['juli']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>8</td>
                                <td>Agustus</td>
                                ...
                                <td>{{$realisasiAgu}}</td>
                                <td>{{round($realisasiAgu / $detailProgress['agustus']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>9</td>
                                <td>September</td>
                                ...
                                <td>{{$realisasiSep}}</td>
                                <td>{{round($realisasiSep / $detailProgress['september']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>10</td>
                                <td>Oktober</td>
                                ...
                                <td>{{$realisasiOkt}}</td>
                                <td>{{round($realisasiOkt / $detailProgress['oktober']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>11</td>
                                <td>November</td>
                                ...
                                <td>{{$realisasiNov}}</td>
                                <td>{{round($realisasiNov / $detailProgress['november']->rencana, 1)}}</td>
                            </tr>
                            <tr>
                                <td>12</td>
                                <td>Desember</td>
                                ...
                                <td>{{$realisasiDes}}</td>
                                <td>{{round($realisasiDes / $detailProgress['desember']->rencana, 1)}}</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
